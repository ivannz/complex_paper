...
layers' biases, shift and scaling from $\real$-and $\cplx$-batch normalization.
...
weights in each layer based on the relevance scores $\alpha$ (sec.~\ref{sub:variational_dropout}).
