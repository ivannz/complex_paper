...
\begin{frame}[c]{\insertsection}
  ...
  \begin{itemize}
    ...
    \item Quantization and fixed point arithmetic\textsuperscript{
        ...
        % {chen_fxpnet_2017} full fixed-point training with fxp batch normalization, ADAM, forward and backprop, adaptive fxp exponent based on the overlfow rate
        % {chen_compressing_2015} weight-agnostic hashing into groups sharing the same value within a layer: hash->bin->shared weight. Hashing allows NOT to store bin indices
