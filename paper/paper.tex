...
exacerbated by the loss being real-valued. Indeed, as implied by Cauchy-Riemann conditions, a
$\cplx$-differentiable real-valued function is necessarily trivial. This issue is dealt with
by employing Wirtinger, or $\cplx\real$ calculus, which generalizes holomorphic calculus
to non-holomorphic functions of $\cplx$-argument, \cite{adali_complex-valued_2011}. It was
considered as a basis for $\cplx$ version of backpropagation in \cite{benvenuto_complex_1992}
and \cite{trabelsi_deep_2017} (see sec.~\ref{sub:wirtinger_calculus} for details). The key
benefit of $\cplx\real$ calculus is straightforward symbolic differentiation, and the fact,
that this allows retrofiting $\cplx$-valued networks into existing $\real$ deep learning
