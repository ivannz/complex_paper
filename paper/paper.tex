...
\subsection{Staged fitting and compression} % (fold)
...
\begin{figure}[ht]
  ...
  \begin{subfigure}[b]{0.95\textwidth}  % imcl2019-style swears at this
    \centering
    \includegraphics[draft,width=1.\linewidth]{../assets/kde-histograms-of-log-alpha-distribution.pdf}
  \end{subfigure} \\%
  % \hfill
  \begin{subfigure}[b]{0.95\textwidth}  % imcl2019-style swears at this
    \centering
    \includegraphics[width=1.\linewidth]{../assets/figure__musicnet__threshold.pdf}
  \end{subfigure}
  \caption{%
    Smoothed density of $\log\alpha$ for a convolutional and dense layer from a model
    in sec.~\ref{sub:mnist_like_datasets}.
  }
...
\begin{equation} \label{eq:prob_relevant}
  ...
  \,.
\end{equation}
% Figure~\ref{fig:hist__and__threshold__tradeoff} (bottom) shows the probability of a $\real$
...
pick $\tau \in [-\tfrac12, \tfrac32]$, which is lower than $\tau = 3$, recommended by
...
\begin{figure}[!ht]
  ...
  \begin{subfigure}[b]{0.95\textwidth}  % imcl2019-style swears at this
    \centering
    % \includegraphics[width=1.\linewidth]{../assets/figure__mnist-like__trade-off/legacy__VD__fashionmnist__fft__-0.5.pdf}
    \includegraphics[width=1.\linewidth]{../assets/figure__mnist-like__trade-off/legacy__VD__kmnist__fft__-0.5.pdf}
  \end{subfigure} \\%
  % \hfill
  \begin{subfigure}[b]{0.95\textwidth}  % imcl2019-style swears at this
    \centering
    % \includegraphics[width=1.\linewidth]{../assets/figure__mnist-like__trade-off/legacy__VD__mnist__fft__-0.5.pdf}
    \includegraphics[width=1.\linewidth]{../assets/figure__mnist-like__trade-off/legacy__VD__emnist_letters__fft__-0.5.pdf}
  \end{subfigure} \\%
  \begin{subfigure}[b]{0.95\textwidth}  % imcl2019-style swears at this
    \centering
    % \includegraphics[width=1.\linewidth]{../assets/figure__mnist-like__trade-off/legacy__VD__fashionmnist__raw__-0.5.pdf}
    \includegraphics[width=1.\linewidth]{../assets/figure__mnist-like__trade-off/legacy__VD__kmnist__raw__-0.5.pdf}
  \end{subfigure} \\%
  % \hfill
  \begin{subfigure}[b]{0.95\textwidth}  % imcl2019-style swears at this
    \centering
    % \includegraphics[width=1.\linewidth]{../assets/figure__mnist-like__trade-off/legacy__VD__mnist__raw__-0.5.pdf}
    \includegraphics[width=1.\linewidth]{../assets/figure__mnist-like__trade-off/legacy__VD__emnist_letters__raw__-0.5.pdf}
  \end{subfigure}
  \caption{%
...
on the full training split of $50k$ colour $32\times32$ images, and use only raw image
...
\begin{figure}[!ht]
  ...
  \begin{subfigure}[b]{0.9\textwidth}  % imcl2019-style swears at this
    \centering
    \includegraphics[draft,width=1.\linewidth]{../assets/figure__cifar10__trade-off/musicnetram__fft__-0.5.pdf}
  \end{subfigure} \\%
  % \hfill
  \begin{subfigure}[b]{0.9\textwidth}  % imcl2019-style swears at this
    \centering
    \includegraphics[draft,width=1.\linewidth]{../assets/figure__cifar10__threshold/cifar10__threshold.pdf}
  \end{subfigure}
  \caption{%
...
\begin{figure}[!ht]
  ...
  \begin{subfigure}[b]{0.9\textwidth}  % imcl2019-style swears at this
    \centering
    \includegraphics[width=1.\linewidth]{../assets/figure__musicnet__trade-off/musicnetram__fft__-0.5.pdf}
  \end{subfigure} \\%
  % \hfill
  \begin{subfigure}[b]{0.9\textwidth}  % imcl2019-style swears at this
    \centering
    % \includegraphics[width=1.\linewidth]{../assets/figure__musicnet__trade-off/musicnetram__fft__-0.5.pdf}
    \includegraphics[draft,width=1.\linewidth]{../assets/figure__musicnet__trade-off/legacy__musicnetram__fft__-0.5.pdf}
  \end{subfigure}
  \caption{%
