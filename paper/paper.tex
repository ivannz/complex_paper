...
We use accuracy as the performance metric for multi-class image classification on CIFAR10 datasets. 
...
% perfromance metrics
Similarly to \citet{trabelsi_deep_2017} performance in experiments with
