...
the lens of Variational Inference and proposed \emph{Variational Dropout}. They argued
...
So, during the $50$ epochs allotted for ``sparsify'' stage, low $C$ prevents the sparsity
