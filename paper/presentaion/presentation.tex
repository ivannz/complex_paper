...
\begin{frame}[c]{\insertsection}
  ...
  \begin{eqnarray*}
    \mathop{KL}\nolimits_{ij}
      &\propto&
        \tfrac{\beta - 2}2 \log \lvert {\color{teal} \mu_{ij}} \rvert^2
        + \log \tfrac1{{\color{red} \alpha_{ij}}}
        - \tfrac\beta2 Ei( - \tfrac1{{\color{red} \alpha_{ij}}})
      \\
  ...
  \bigskip
  ($\cplx$-ARD) empirical Bayes \eqref{eq:elbo} is optimized w.r.t. precision ${\color{teal} \tau_{ij}}$
  \begin{eqnarray*}
    \mathop{KL}\nolimits_{ij}
      &=& -1
