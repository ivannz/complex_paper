...
approximation against a Monte-Carlo estimate for $\alpha$ varying over a fine logarithmic
grid and the exact expression for gradient of \eqref{eq:improper-kl-div-real}.
...
``pre-train'' stage, except for training only those parameters, which are specified
by sparsity masks.
