...
\begin{figure}[ht]
  \centering
  \includegraphics[draft,width=1.\linewidth]{../assets/log-alpha__sum__fashion-mnist.pdf}
  \caption{%
...
\begin{equation} \label{eq:prob_relevant}
  ...
  \,.
\end{equation}
% Figure~\ref{fig:log-alpha__mnist-like} (bottom) shows the probability of a $\real$
% (or $\cplx$)  parameter being non-zero for various $\delta\in(0, \tfrac12)$ as a function
% of $\log \alpha$.
...
\begin{figure}[!ht]
  ...
  \begin{subfigure}[b]{0.95\textwidth}  % imcl2019-style swears at this
    \centering
    \includegraphics[draft,width=1.\linewidth]{../assets/sum__mnist__fine-tune.pdf}
    % \caption{} \label{fig:log-alpha-kde}
  \end{subfigure} \\%
  % \hfill
  \begin{subfigure}[b]{0.95\textwidth}  % imcl2019-style swears at this
    \centering
    \includegraphics[draft,width=1.\linewidth]{../assets/sum__fashion-mnist__fine-tune.pdf}
    % \caption{} \label{fig:log-alpha-proba}
  \end{subfigure}
  \caption{%
    The accuracy-compression trade-off after ``fine-tune''.
    \textit{top}: MNIST \citep{citation_needed};
    \textit{bottom}: Fashion MNIST \citep{citation_needed}.
  }
  \label{fig:mnist-like_trade-off}
\end{figure}

The same approach was applied to
CIFAR10 (sec.~\ref{sub:cifar10_100} experiments, which could partly explain the overall
poor test performance we got from the tested VGG16 model ($\real$ and $\cplx$ version).
...
\begin{figure}[!ht]
  ...
  \begin{subfigure}[b]{0.9\textwidth}  % imcl2019-style swears at this
    \centering
    \includegraphics[draft,width=1.\linewidth]{../assets/grid_cplx_fine_kl_div_v3_fast-fine-tune.pdf}
    % \caption{} \label{fig:log-alpha-kde}
  \end{subfigure} \\
  % \hfill
  \begin{subfigure}[b]{0.9\textwidth}  % imcl2019-style swears at this
    \centering
    \includegraphics[draft,width=1.\linewidth]{../assets/grid_cplx_fine_kl_div_v2-fine-tune.pdf}
    % \caption{} \label{fig:log-alpha-proba}
  \end{subfigure}
  \caption{%
...
\begin{figure}[!ht]
  ...
  \begin{subfigure}[b]{0.9\textwidth}  % imcl2019-style swears at this
    \centering
    \includegraphics[draft,width=1.\linewidth]{../assets/grid_cplx_fine_kl_div_v3_fast-c-ard-trade-off.pdf}
    % \caption{} \label{fig:log-alpha-kde}
  \end{subfigure} \\
  % \hfill
  \begin{subfigure}[b]{0.9\textwidth}  % imcl2019-style swears at this
