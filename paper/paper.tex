...
Throughout every experiment on MNIST-like datasets (sec.~\ref{sub:mnist_like_datasets},
we \textit{fixed} a random subset of the train split of each dataset, and used the test
split to gauge the final performance. The same approach was applied to CIFAR10 (sec.~%
...
state of the optimizer for related parameters are transferred between stages.
...
(top) displays the general shape of the distribution of $\log \alpha$ values from all
experiments in sec.~\ref{sub:mnist_like_datasets}. In fact, this appears to be the typical
in every experiment conducted in this study: there always is a single mode within the
moderately negative range, and one or two modes to the right of zero. The relative mass
of each mode changes with $C$ and the higher the coefficient is, the more mass is shifted
to the right. In every experiment the trough between the peaks of the negative mode and
the first positive one is around zero.

\begin{figure}[!ht]
  \centering
  \begin{subfigure}[b]{0.9\textwidth}  % imcl2019-style swears at this
    \centering
    \includegraphics[width=1.\linewidth]{../assets/log-alpha__sum__mnist__20200131-202713.pdf}
    % \caption{} \label{fig:log-relevance-kde}
  \end{subfigure} \\
  % \hfill
  \begin{subfigure}[b]{0.9\textwidth}  % imcl2019-style swears at this
    \centering
    \includegraphics[width=1.\linewidth]{../assets/log-alpha__sum__fashion-mnist__20200131-205926.pdf}
...
\begin{figure}[!ht]
  ...
  \begin{subfigure}[b]{0.95\textwidth}  % imcl2019-style swears at this
    \centering
    \includegraphics[width=1.\linewidth]{../assets/sum__mnist__fine-tune.pdf}
    % \caption{} \label{fig:log-relevance-kde}
  \end{subfigure} \\%
  % \hfill
  \begin{subfigure}[b]{0.95\textwidth}  % imcl2019-style swears at this
    \centering
    \includegraphics[width=1.\linewidth]{../assets/sum__fashion-mnist__fine-tune.pdf}
    % \caption{} \label{fig:log-relevance-proba}
  \end{subfigure}
  \caption{%
    The accuracy-compression tradeoff after ``fine-tune''.
    \textit{top}: MNIST \citep{citation_needed};
    \textit{bottom}: Fashion MNIST \citep{citation_needed}.
  }
  \label{fig:mnist-like_tradeoff}
\end{figure}
...
\begin{figure}[!ht]
  ...
  \begin{subfigure}[b]{0.9\textwidth}  % imcl2019-style swears at this
    \centering
    \includegraphics[width=1.\linewidth]{../assets/grid_cplx_fine_kl_div_v3_fast-fine-tune.pdf}
    % \caption{} \label{fig:log-relevance-kde}
  \end{subfigure} \\
  % \hfill
  \begin{subfigure}[b]{0.9\textwidth}  % imcl2019-style swears at this
    \centering
    \includegraphics[width=1.\linewidth]{../assets/grid_cplx_fine_kl_div_v2-fine-tune.pdf}
    % \caption{} \label{fig:log-relevance-proba}
  \end{subfigure}
  \caption{%
...
\begin{figure}[!ht]
  ...
  \begin{subfigure}[b]{0.9\textwidth}  % imcl2019-style swears at this
    \centering
    \includegraphics[width=1.\linewidth]{../assets/grid_cplx_fine_kl_div_v3_fast-c-ard-tradeoff.pdf}
    % \caption{} \label{fig:log-relevance-kde}
  \end{subfigure} \\
  % \hfill
  \begin{subfigure}[b]{0.9\textwidth}  % imcl2019-style swears at this
  ...
  \end{subfigure}
  \caption{%
    Pre ``finte-tune'' performance of the best models from figure \ref{fig:musicnet_tradeoff}
  ...
  \label{fig:musicnet_tradeoff_pre_fune-tune}
\end{figure}
