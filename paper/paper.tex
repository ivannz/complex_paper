...
% discussion of TwoLayerDenseModel
% discussion of SimpleConvModel
...
\begin{figure}[!ht]
  ...
  \begin{subfigure}[b]{0.95\textwidth}  % imcl2019-style swears at this
    \centering
    \includegraphics[draft,width=1.\linewidth]{../assets/sum__mnist__fine-tune__TwoLayerDenseModelVD.pdf}
    % \caption{} \label{fig:log-alpha-kde}
  \end{subfigure} \\%
  % \hfill
  \begin{subfigure}[b]{0.95\textwidth}  % imcl2019-style swears at this
    \centering
    \includegraphics[draft,width=1.\linewidth]{../assets/sum__mnist__fine-tune__SimpleConvModelVD.pdf}
...
\begin{figure}[!ht]
  ...
  \begin{subfigure}[b]{0.95\textwidth}  % imcl2019-style swears at this
    \centering
    \includegraphics[draft,width=1.\linewidth]{../assets/sum__mnist__fine-tune__TwoLayerDenseModelARD.pdf}
    % \caption{} \label{fig:log-alpha-kde}
  \end{subfigure} \\%
  % \hfill
  \begin{subfigure}[b]{0.95\textwidth}  % imcl2019-style swears at this
    \centering
    \includegraphics[draft,width=1.\linewidth]{../assets/sum__mnist__fine-tune__SimpleConvModelARD.pdf}
    % \caption{} \label{fig:log-alpha-proba}
  \end{subfigure}
  \caption{%
    The compression-accuracy trade-off after ``fine-tune'' on MNIST of \textit{TwoLayerDenseModel}
...
that we study VGG16 model, \citep{citation_needed}, and its $\cplx$-counterpart, fit
