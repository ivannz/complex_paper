...
images to study the compression-performance trade-off of the proposed $\cplx$-variational
...
comprising $32\times 32$ color images of $10$ classes to study the compression-performance
...
\begin{figure}[!t]
  ...
  \caption{%
    ...
    and the ${\color{pink} k_3}$ version compressed with VD.
  }
...
on figure~\ref{fig:hist__and__threshold__tradeoff}. From \eqref{eq:elbo_with_coef} and
...
% (pending) threshold and fune-tuning?
% By reducing the excess degrees of freedom, high compression rates could act as a regularizer,
% leaving less capacity for overfitting. Which seems sufficient enough for models in higher
% compression regime
