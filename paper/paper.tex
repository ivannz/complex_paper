...
\eqref{eq:sgvb_estimator}, by rendering the gradient with respect to $\mu$ independent
from the local output noise, injected by \eqref{eq:r-gauss-trick}. This improvement is
especially important for model pruning, since $\mu$ of relevant parameters are used
