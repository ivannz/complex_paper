...
\begin{figure}[!ht]
  ...
  \begin{subfigure}[b]{0.9\textwidth}  % imcl2019-style swears at this
    \centering
    \includegraphics[width=1.\linewidth,draft]{../assets/log-alpha__histograms.pdf}
    % \caption{} \label{fig:log-relevance-kde}
  \end{subfigure} \\
  % \hfill
  \begin{subfigure}[b]{0.9\textwidth}  % imcl2019-style swears at this
    \centering
    \includegraphics[width=1.\linewidth,draft]{../assets/proba_of_nonzero.pdf}
...
\begin{figure}[!ht]
  ...
  \end{subfigure}
  \caption{%
    \textit{top}: The performance-compression tradeoff for MNIST \citep{citation_needed}.
    \textit{bottom}: The performance-compression tradeoff for Fashion MNIST \citep{citation_needed}.
  }
...
\begin{figure}[!ht]
  ...
  \end{subfigure}
  \caption{%
    \textit{top}: MusicNet for the model of \citep{trabelsi_deep_2017} with kernel size $3$.
    \textit{bottom}: The performance-compression tradeoff for Fashion MNIST \citep{citation_needed}.
  }
  \label{fig:mnist-like_tradeoff}
\end{figure}
