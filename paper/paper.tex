...
linear layer follow
% We use MAP estimates of bias terms, i.e. assume an independent fully factorized Dirac approximation.
...
\begin{figure}[!t]
  ...
  \begin{subfigure}[b]{0.95\textwidth}  % imcl2019-style swears at this
    \centering
    \includegraphics[width=\columnwidth]{../assets/figure__musicnet__threshold.pdf}
  \end{subfigure}
  \caption{%
...
dropout methods seem to compress networks adequately well without much loss in performance.
...
\begin{figure}[!t]
  ...
  \begin{subfigure}[b]{1.\textwidth}  % imcl2019-style swears at this
    ...
    \includegraphics[width=0.8\columnwidth]{../assets/figure__mnist-like__trade-off/legacy__VD__kmnist__fft__-0.5.pdf}
  ...
  \begin{subfigure}[b]{1.\textwidth}  % imcl2019-style swears at this
    ...
    \includegraphics[width=0.8\columnwidth]{../assets/figure__mnist-like__trade-off/legacy__VD__kmnist__raw__-0.5.pdf}
  ...
  \begin{subfigure}[b]{1.\textwidth}  % imcl2019-style swears at this
    ...
    \includegraphics[width=0.8\columnwidth]{../assets/figure__mnist-like__trade-off/legacy__VD__emnist_letters__fft__-0.5.pdf}
  ...
  \begin{subfigure}[b]{1.\textwidth}  % imcl2019-style swears at this
    ...
    \includegraphics[width=0.8\columnwidth]{../assets/figure__mnist-like__trade-off/legacy__VD__emnist_letters__raw__-0.5.pdf}
...
\begin{figure}[!t]
  ...
  \begin{subfigure}[b]{0.9\textwidth}  % imcl2019-style swears at this
    \centering
    \includegraphics[width=\columnwidth]{../assets/figure__cifar__trade-off/legacy__augmentedcifar10__raw__-0.5.pdf}
  \end{subfigure}
  \caption{%
...
musical compositions. Folowing \citet{trabelsi_deep_2017}, we use it for automatic music
...
\begin{figure}[!h]
  ...
  \begin{subfigure}[b]{1.\textwidth}  % imcl2019-style swears at this
    \centering
    \includegraphics[width=\columnwidth]{../assets/figure__musicnet__trade-off/paper__musicnetram__fft__-0.5.pdf}
  \end{subfigure}
  \caption{%
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=\linewidth]{../assets/grad_log.pdf}
