...
$\cplx$-variational dropout on simple architectures.
...
First we try to compare the $\real$-valued networks against their $\cplx$-valued counterparts
with approximately half as many parameters, as suggested by \citet{monning_evaluation_2018}.
In this experiment, ``dense'', ``sparsify'' and ``fine-tune'' stages last for $40$, $75$
and $40$ epochs, respectively. The base learning rate is scaled after $5$, $10$, and $20$
epochs by $\tfrac1{10}$, $\tfrac1{20}$ and $\tfrac1{100}$, respectively.
